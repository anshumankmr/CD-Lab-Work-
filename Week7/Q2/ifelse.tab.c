...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from ifelse.y  */
...
const int YY_parse_CLASS::NL=258;
const int YY_parse_CLASS::ID=259;
const int YY_parse_CLASS::EQ=260;
const int YY_parse_CLASS::OB=261;
const int YY_parse_CLASS::CB=262;
const int YY_parse_CLASS::OCB=263;
const int YY_parse_CLASS::CCB=264;
const int YY_parse_CLASS::IF=265;
const int YY_parse_CLASS::ELSE=266;
const int YY_parse_CLASS::NUM=267;
const int YY_parse_CLASS::PLUS=268;
const int YY_parse_CLASS::MINUS=269;
const int YY_parse_CLASS::LT=270;
const int YY_parse_CLASS::GT=271;
const int YY_parse_CLASS::IEQ=272;
const int YY_parse_CLASS::SC=273;
...
static const short yyprhs[] = {     0,
     0,     3,    15,    23,    24,    27,    29,    35,    39,    43,
    47,    51,    55,    57,    59
};

static const short yyrhs[] = {    20,
     3,     0,    10,     6,    24,     7,     3,     8,     3,    22,
     9,     3,    21,     0,    11,     3,     8,     3,    22,     9,
     3,     0,     0,    23,    22,     0,    23,     0,     4,     5,
    24,    18,     3,     0,    24,    13,    25,     0,    24,    14,
    25,     0,    25,    15,    25,     0,    25,    16,    25,     0,
    25,    17,    25,     0,    25,     0,     4,     0,    12,     0
};
...
static const short yyrline[] = { 0,
    10,    12,    14,    15,    17,    18,    20,    22,    23,    24,
    25,    26,    27,    29,    30
};

static const char * const yytname[] = {   "$","error","$illegal.","NL","ID",
"EQ","OB","CB","OCB","CCB","IF","ELSE","NUM","PLUS","MINUS","LT","GT","IEQ",
"SC","stmtprime","dec_stmt","dprime","stmt_list","stmt","exp","term",""
};
#endif

static const short yyr1[] = {     0,
    19,    20,    21,    21,    22,    22,    23,    24,    24,    24,
    24,    24,    24,    25,    25
};

static const short yyr2[] = {     0,
     2,    11,     7,     0,     2,     1,     5,     3,     3,     3,
     3,     3,     1,     1,     1
};

static const short yydefact[] = {     0,
     0,     0,     0,     1,    14,    15,     0,    13,     0,     0,
...
static const short yypact[] = {    -8,
    -1,     3,    -3,-32768,-32768,-32768,     0,     6,     7,    -3,
    -3,    -3,    -3,    -3,    12,-32768,-32768,-32768,-32768,-32768,
     8,    20,    21,    16,    20,    -3,    24,-32768,   -10,    17,
    26,    27,-32768,-32768,    23,    29,    20,    25,    30,-32768,
    35,    36,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,   -25,-32768,    11,     5
};
...
static const short yytable[] = {    28,
     5,     1,    10,    11,     3,     4,     9,    31,     6,    15,
    22,    38,    10,    11,    16,    17,    18,    19,    20,    21,
    12,    13,    14,    23,    27,    26,    30,    32,    34,    35,
    36,    37,    40,    39,    42,    43,    29
};

static const short yycheck[] = {    25,
     4,    10,    13,    14,     6,     3,     7,    18,    12,     3,
     3,    37,    13,    14,    10,    11,    12,    13,    14,     8,
    15,    16,    17,     4,     9,     5,     3,    11,     3,     3,
     8,     3,     3,     9,     0,     0,    26
};
