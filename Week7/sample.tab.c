...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from sample.y  */
...
const int YY_parse_CLASS::NUMBER=260;
const int YY_parse_CLASS::PLUS=261;
const int YY_parse_CLASS::MINUS=262;
...
"NUMBER","PLUS","MINUS","'+'","'-'","stmt","exp","term",""
};
#endif
...
-32768,-32768,    -3,-32768,-32768,     1,     1,-32768,-32768,     7,
     8,-32768
};
